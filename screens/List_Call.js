  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
          ...
          <SafeAreaView style={styles.muser}>
            <TouchableOpacity style={styles.mbuttonUser}>
              ...
              <Modal isVisible={isModalVisible2} style={{ justifyContent: 'center', margin: 10, height: '50vh', width: '95%', top: '5%', }} animationIn={'slideInUp'} animationOut={'slideOutDown'}>
      ...
      <Text style={styles.amtitle}>Cài đặt</Text>
        ...
        <TouchableOpacity style={styles.ambutton} onPress={toggleModal2}>
